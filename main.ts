...
sprites.onCreated(SpriteKind.Enemy, function (sprite) {
    ...
    sprite.x = 155
    sprite.setVelocity(randint(-75, -100), 0)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Coin, function (sprite, otherSprite) {
    otherSprite.y = randint(10, 110)
    otherSprite.x = 155
    info.changeScoreBy(1)
    car1.setVelocity(car1.vx + 1, 0)
    car2.setVelocity(car2.vx + 1, 0)
    car3.setVelocity(car3.vx + 1, 0)
})
sprites.onOverlap(SpriteKind.Coin, SpriteKind.Coin, function (sprite, otherSprite) {
    sprite.y = randint(10, 110)
    sprite.vx = randint(-75, -30)
    sprite.x = 155
})
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Coin, function (sprite, otherSprite) {
    otherSprite.y = randint(10, 110)
    otherSprite.vx = randint(-75, -30)
    otherSprite.x = 155
})
...
info.onLifeZero(function () {
    ...
    car2.destroy()
    car3.destroy()
    game.splash("Final Score: " + info.score())
})
...
car2 = sprites.create(img`
    ...
    . . . . b b f . . . . b b f . . 
    `, SpriteKind.Enemy)
car2.setFlag(SpriteFlag.Invisible, true)
car2.setFlag(SpriteFlag.Ghost, true)
car3 = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Enemy)
car3.setFlag(SpriteFlag.Invisible, true)
car3.setFlag(SpriteFlag.Ghost, true)
...
game.onUpdate(function () {
    man.y += controller.dy()
    coins = sprites.allOfKind(SpriteKind.Coin)
    for (let coin of coins) {
        if (coin.x < 0) {
            coin.vx = randint(-85, -50)
            coin.x = 155
            coin.y = randint(10, 110)
        }
    }
    cars = sprites.allOfKind(SpriteKind.Enemy)
    for (let car of cars) {
        if (car.x < 0) {
            car.x = 155
            car.y = randint(10, 110)
            car.setVelocity(randint(-75, -100), 0)
        }
    }
    if (info.score() == 10) {
        car2.setFlag(SpriteFlag.Invisible, false)
        car2.setFlag(SpriteFlag.Ghost, false)
    }
    if (info.score() == 25) {
        car3.setFlag(SpriteFlag.Invisible, false)
        car3.setFlag(SpriteFlag.Ghost, false)
    }
    if (info.score() == 14.5) {
